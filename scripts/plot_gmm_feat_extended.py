...
def plotGMM(subplot, fileGMM, xDim, yDim, percents, colorGmm, filesFeat, colorFeat=None, limits=None):
    ...
    plt.axis('tight')
    plt.axis(limits)
    plt.savefig('img/ext.png', bbox_inches='tight')
    #plt.show()
...
Usage:
    plot_gmm_feat_extended [--help|-h] [options] <file-gmm-1> [<file-feat-1>] [<file-gmm-2>] [<file-feat-2>]
...
Arguments:
    <file-gmm-1>    File with the first Gaussian mixture model to be plotted
    <file-feat-1>   Feature files to be plotted along the first GMM
    <file-gmm-2>    File with the second Gaussian mixture model to be plotted
    <file-feat-2>   Feature files to be plotted along the second GMM
...
if __name__ == '__main__':
    ...
    fileGMM_1 = args['<file-gmm-1>']
    fileGMM_2 = args['<file-gmm-2>']
    filesFeat_1 = args['<file-feat-1>']
    filesFeat_2 = args['<file-feat-2>']
    xDim = int(args['--xDim'])
    yDim = int(args['--yDim'])
    ...
    plotGMM(221,fileGMM_1, xDim, yDim, percents, colorGmm, filesFeat_1, colorFeat, limits)
    plotGMM(222,fileGMM_1, xDim, yDim, percents, colorGmm, filesFeat_2, colorFeat, limits)
    plotGMM(223,fileGMM_2, xDim, yDim, percents, colorGmm, filesFeat_1, colorFeat, limits)
    plotGMM(224,fileGMM_2, xDim, yDim, percents, colorGmm, filesFeat_2, colorFeat, limits)
